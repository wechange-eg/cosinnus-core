...
@override_settings(AUTH_PASSWORD_VALIDATORS=[{'NAME': 'cosinnus.utils.validators.BSISafePasswordValidator',}])
class ValidatorTestCase(TestCase):
    ...
    def test_mismatching_passwords(self):
        ...
        self.assertIn(
            'password_mismatch', self.get_error_message_code(form.errors)
        )
    ...
    def test_missing_special_character(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn(
            'password_no_special_character', self.get_error_message_code(form.errors)
        )
    ...
    def test_missing_capital_letter(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn(
            'password_no_uppercase_character', self.get_error_message_code(form.errors)
        )
    ...
    def missing_small_letter(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn(
            'password_no_lowercase_character', self.get_error_message_code(form.errors)
        )
    ...
    def missing_digit(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn(
            'password_no_digit', self.get_error_message_code(form.errors)
        )
