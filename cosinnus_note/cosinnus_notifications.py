...
notifications = {
    'note_comment_posted_on_any': {
        ...
        'data_attributes': {
            ...
            'image_url': 'note.creator.cosinnus_profile.get_avatar_thumbnail_url',
    ...
    'note_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your news post %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your news post %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
    ...
    'note_comment_posted_in_commented_post': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the news post %(object_name)s you '
            'commented in',
            '%(sender_name)s and %(count_minus_one)d others commented on the news post %(object_name)s you '
            'commented in',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
    ...
    'following_note_comment_posted': {
        ...
        'supercedes_notifications': [
            'note_comment_posted_on_commented_post',
            'note_comment_posted',
            'note_comment_posted_on_any',
        ],
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the news post %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on the news post %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'alert_reason': _('You are following this news post'),
