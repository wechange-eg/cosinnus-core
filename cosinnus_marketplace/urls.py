...
cosinnus_group_patterns = [
    ...
    re_path(r'^(?P<slug>[^/]+)/activate/$', views.offer_activate_or_deactivate_view, {'mode': 'activate'}, name='activate'),
    re_path(r'^(?P<slug>[^/]+)/deactivate/$', views.offer_activate_or_deactivate_view, {'mode': 'deactivate'}, name='deactivate'),
