...
notifications = {
    ...
    'offer_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your offer %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your offer %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
    ...
    'tagged_offer_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the offer %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on the offer %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
