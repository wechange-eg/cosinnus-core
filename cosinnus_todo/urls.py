...
cosinnus_group_patterns = [
    ...
    re_path(r'^list/(?P<listslug>[^/]+)/show/(?P<todoslug>[^/]+)/$', views.todo_list_create_view, name='todo-in-list-list'),
...
cosinnus_api_patterns = api_patterns(1, 'todo', True,
    ...
    re_path(r'^todos/(?P<pk>[0-9a-zA-Z_-]+)/toggle_complete/me/$', views.entry_toggle_complete_me_view_api, name='entry-toggle-complete-me'),
