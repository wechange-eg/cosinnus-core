...
notifications = {
    ...
    'todo_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your todo %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your todo %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
    ...
    'tagged_todo_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the todo %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on the todo %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
    ...
    'assigned_todo_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your assigned todo %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your assigned todo %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
    ...
    'following_todo_changed': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other updated the todo %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others updated the todo %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
