...
notifications = {
    ...
    'event_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your event %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your event %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
    ...
    'tagged_event_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the event %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on the event %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
    ...
    'following_doodle_voted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other voted in the event poll %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others voted in the event poll %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'alert_reason': _('You are following this event poll'),
