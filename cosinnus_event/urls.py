...
cosinnus_group_patterns = [
    ...
    re_path(r'^conference/(?P<room_slug>[^/]+)/add/$', views.conference_event_add_view, {'form_view': 'add'}, name='conference-event-add'),
    re_path(r'^conference/(?P<room_slug>[^/]+)/edit/(?P<slug>[^/]+)/$', views.conference_event_edit_view, {'form_view': 'edit'}, name='conference-event-edit'),
    re_path(r'^conference/(?P<room_slug>[^/]+)/delete/(?P<slug>[^/]+)/$', views.conference_event_delete_view, {'form_view': 'delete'}, name='conference-event-delete'),
    # deprecated URL, see 'team-conference-event-entry' for the new URL. left as backwards compatibility for old ical imports. 
    re_path(r'^conference/feed/(?P<slug>[^/]+)/$', views.conference_event_ical_feed_single, name='conference-event-entry'),
...
cosinnus_root_patterns = [
    ...
    path('events/team/<int:team_id>/conference/feed/<slug:slug>/', views.team_conference_event_ical_feed_single, name='team-conference-event-entry'),
