...
urlpatterns = [
    ...
    path('account/list-unsubscribe/<str:email>/<str:token>/', user.add_email_to_blacklist, name='user-add-email-blacklist'),
    path('account/list-unsubscribe-result/', user.add_email_to_blacklist_result, name='user-add-email-blacklist-result'),
    path('account/deactivated/', group.group_list_mine_deactivated, name='deactivated-groups'),
    path('account/activate/<int:group_id>/', group.activate_or_deactivate, name='group-activate', kwargs={'activate': True}),
    path('account/deactivate/<int:group_id>/', group.activate_or_deactivate, name='group-deactivate', kwargs={'activate': False}),
    ...
    path('administration/list-unsubscribe/<str:email>/<str:token>/', user.add_email_to_blacklist, name='OLD-user-add-email-blacklist'),
    path('administration/list-unsubscribe-result/', user.add_email_to_blacklist_result, name='OLD-user-add-email-blacklist-result'),
    path('administration/deactivated/', group.group_list_mine_deactivated, name='OLD-deactivated-groups'),
    path('administration/activate/<int:group_id>/', group.activate_or_deactivate, name='OLD-group-activate', kwargs={'activate': True}),
    path('administration/deactivate/<int:group_id>/', group.activate_or_deactivate, name='OLD-group-deactivate', kwargs={'activate': False}),
    path('administration/verify_email/<str:email_verification_param>/', user.verifiy_user_email, name='OLD-user-verifiy-email'),
    # ---- END DEPRECATED ---
    ...
    path('administration/group_newsletter/', administration.groups_newsletters, name='administration-groups-newsletter'),
    path('administration/group_newsletter/add/', administration.groups_newsletter_create, name='administration-groups-newsletter-create'),
    path('administration/group_newsletter/<int:newsletter_id>/edit/', administration.groups_newsletter_update, name='administration-groups-newsletter-update'),
    path('administration/tag_newsletter/', administration.managed_tags_newsletters, name='administration-managed-tags-newsletter'),
    path('administration/tag_newsletter/add/', administration.managed_tags_newsletter_create, name='administration-managed-tags-newsletter-create'),
    path('administration/tag_newsletter/<int:newsletter_id>/edit/', administration.managed_tags_newsletter_update, name='administration-managed-tags-newsletter-update'),

    path('administration/announcements/', user_dashboard_announcement.list_view, name='user-dashboard-announcement-list'),
    path('administration/announcements/add/', user_dashboard_announcement.user_dashboard_announcement_create, name='user-dashboard-announcement-create'),
    path('administration/announcement/<slug:slug>/edit/', user_dashboard_announcement.user_dashboard_announcement_edit, name='user-dashboard-announcement-edit'),
    path('administration/announcement/<slug:slug>/delete/', user_dashboard_announcement.user_dashboard_announcement_delete, name='user-dashboard-announcement-delete'),
    path('administration/announcement/<slug:slug>/activate-toggle/', user_dashboard_announcement.user_dashboard_announcement_activate, name='user-dashboard-announcement-activate'),
    
    path('conference_administration/', conference_administration.conference_administration, name='conference-administration'),
    path('administration/conference_overview/', conference_administration.conference_overview, name='conference-administration-overview'),
    path('administration/conference_overview/nonstandard/', conference_administration.conference_overview, name='conference-administration-overview-nonstandard', kwargs={'only_nonstandard': True}),
    path('administration/conference_overview/premium/', conference_administration.conference_overview, name='conference-administration-overview-premium', kwargs={'only_premium': True}),
    path('administration/conference/<slug:slug>/blocks/add/', conference_administration.conference_add_premium_block, name='conference-administration-add-premium-block'),
    path('administration/conference/block/<int:block_id>/edit/', conference_administration.conference_edit_premium_block, name='conference-administration-edit-premium-block'),
    
    path('statistics/simple/', statistics.simple_statistics, name='simple-statistics'),
    
    path('housekeeping/ensure_group_widgets/', housekeeping.ensure_group_widgets, name='housekeeping-ensure-group-widgets'),
    ...
    path('housekeeping/neverloggedinuseremails/', housekeeping.never_logged_in_user_emails, name='housekeeping-never-logged-in-user-emails'),
    path('housekeeping/deletespamusers/', housekeeping.delete_spam_users, name='housekeeping_delete_spam_users'),
    path('housekeeping/movegroupcontent/<str:fromgroup>/<str:togroup>/', housekeeping.move_group_content, name='housekeeping_move_group_content'),
    path('housekeeping/recreategroupwidgets/', housekeeping.recreate_all_group_widgets, name='housekeeping_recreate_all_group_widgets'),
    ...
    path('housekeeping/test_logging/info/', housekeeping.test_logging, name='housekeeping-test-logging', kwargs={'level': 'info'}),
    path('housekeeping/test_logging/warning/', housekeeping.test_logging, name='housekeeping-test-logging', kwargs={'level': 'warning'}),
    path('housekeeping/test_logging/error/', housekeeping.test_logging, name='housekeeping-test-logging', kwargs={'level': 'error'}),
    path('housekeeping/test_logging/exception/', housekeeping.test_logging, name='housekeeping-test-logging', kwargs={'level': 'exception'}),
    path('housekeeping/validate_redirects/', housekeeping.check_and_delete_loop_redirects, name='housekeeping-validate-redirects'),
    path('housekeeping/add_members_to_forum/', housekeeping.add_members_to_forum, name='housekeeping-add-members-to-forum'),
    path('housekeeping/user_statistics/', housekeeping.user_statistics, name='housekeeping-user-statistics'),
    path('housekeeping/create_map_test_entities/<int:count>/', housekeeping.create_map_test_entities, name='housekeeping-create-map-test-entities'),
    path('housekeeping/reset_user_tos_flags/', housekeeping.reset_user_tos_flags, name='housekeeping-reset-user-tos-flags'),
    ...
    path('housekeeping/print_digest_daily/', housekeeping.print_testdigest_daily, name='housekeeping-print-digest-daily'),
    path('housekeeping/print_digest_weekly/', housekeeping.print_testdigest_weekly, name='housekeeping-print-digest-weekly'),
    path('housekeeping/print_settings/', housekeeping.print_settings, name='housekeeping-print-settings'),
    path('housekeeping/conf_settings_info/', housekeeping.portal_switches_and_settings, name='housekeeping-portal-switches-and-settings'),
    path('housekeeping/group_admin_emails/<str:slugs>/', housekeeping.group_admin_emails, name='housekeeping-group-admin-emails'),
...
if getattr(settings, 'COSINNUS_USER_IMPORT_ADMINISTRATION_VIEWS_ENABLED', False):
    urlpatterns += [
        ...
        path('administration/user_import/archived/', user_import.archived_user_import_list_view, name='administration-archived-user-import-list'),
        path('administration/user_import/archived/<int:pk>/', user_import.archived_user_import_detail_view, name='administration-archived-user-import-detail'),
        path('administration/user_import/archived/<int:pk>/delete/', user_import.archived_user_import_delete_view, name='administration-archived-user-import-delete'),
    ]
...
if getattr(settings, 'COSINNUS_USER_EXPORT_ADMINISTRATION_VIEWS_ENABLED', False):
    urlpatterns += [
        ...
        path('administration/user_export/download/csv/', user_export.user_export_csv_download_view, name='administration-user-export-csv-download'),
...
if getattr(settings, 'COSINNUS_USE_V2_DASHBOARD', False) or getattr(settings, 'COSINNUS_USE_V2_DASHBOARD_ADMIN_ONLY', False):
    ...
    if getattr(settings, 'COSINNUS_CLOUD_ENABLED', False):
        ...
        urlpatterns += [
            path('dashboard/api/user_typed_content/cloud_files/', cosinnus_cloud_views.api_user_cloud_files_content, name='user-dashboard-api-typed-content-cloud'),
            path('dashboard/api/user_typed_content/recent/cloud_files/', cosinnus_cloud_views.api_user_cloud_files_content, name='user-dashboard-api-typed-content-cloud', kwargs={'show_recent':True}),
    ...
    urlpatterns += [
        ...
        path('dashboard/api/user_liked_ideas/', user_dashboard.api_user_liked_ideas, name='user-dashboard-api-liked-ideas'),
        path('dashboard/api/user_starred_users/', user_dashboard.api_user_starred_users, name='user-dashboard-api-starred-users'),
        path('dashboard/api/user_starred_objects/', user_dashboard.api_user_starred_objects, name='user-dashboard-api-starred-objects'),
        path('dashboard/api/user_followed_objects/', user_dashboard.api_user_followed_objects, name='user-dashboard-api-followed-objects'),
        path('dashboard/api/user_typed_content/<str:content>/', user_dashboard.api_user_typed_content, name='user-dashboard-api-typed-content'),
        path('dashboard/api/user_typed_content/recent/<str:content>/', user_dashboard.api_user_typed_content, name='user-dashboard-api-typed-content', kwargs={'show_recent':True}),
        path('dashboard/api/timeline/<str:content>/', user_dashboard.api_timeline, name='user-dashboard-api-timeline-filtered'),
...
if getattr(settings, 'COSINNUS_USE_V2_NAVBAR', False) or getattr(settings, 'COSINNUS_USE_V2_NAVBAR_ADMIN_ONLY', False):
    urlpatterns += [
        ...
        path('version_history/api/markread/', version_history.version_history_mark_read, name='version-history-api-mark-read'),
    ]
...
if settings.COSINNUS_USER_2_FACTOR_AUTH_ENABLED:
    urlpatterns += [
        ...
        path('two_factor_auth/token_login/backup/', authentication.user_otp_token_validation, name='two-factor-auth-token-backup', kwargs={'two_factor_method': 'backup'}),
        ...
        path('two_factor_auth/settings/setup/complete/', authentication.two_factor_auth_setup_complete, name='two-factor-auth-setup-complete'),
        path('two_factor_auth/settings/disable/', authentication.two_factor_auth_disable, name='two-factor-auth-disable'),
        path('two_factor_auth/settings/backup_tokens/', authentication.two_factor_auth_back_tokens, name='two-factor-auth-backup-tokens'),
    ]
...
if settings.COSINNUS_FACEBOOK_INTEGRATION_ENABLED:
    urlpatterns += [
        path('fb-integration/save-auth-tokens/', facebook_integration.save_auth_tokens,  name='facebook-save-auth-tokens'),
        path('fb-integration/remove-facebook/', facebook_integration.remove_facebook_association,  name='facebook-remove-association'),
        path('fb-integration/confirm-page-admin/<int:group_id>/', facebook_integration.confirm_page_admin,  name='facebook-confirm-page-admin'),
    ]
...
if settings.COSINNUS_CUSTOM_PREMIUM_PAGE_ENABLED:
    urlpatterns += [
        path('portal/supporters/', TemplateView.as_view(template_name='premium_info_page.html'), name='premium-info-page'),
    ]
...
for url_key in group_model_registry:
    ...
    urlpatterns += [
        path(f'{plural_url_key}/in-group-with/<str:group>/', group.group_list_filtered, name=prefix+'group-list-filtered'),
        ...
        path(f'{url_key}/<str:group>/members/recruitdelete/<int:id>/', group.group_user_recruit_delete, name=prefix+'group-user-recruit-delete'),
        ...
        path(f'{url_key}/<str:group>/auto-join/', group.group_user_join_csrf_exempt, name=prefix+'group-user-join-nocsrf'),
        ...
        path(f'{url_key}/<str:group>/decline/', group.group_user_invitation_decline, name=prefix+'group-user-decline'),
        ...
        path(f'{url_key}/<str:group>/organizations/request/', group.group_organization_request, name=prefix+'group-organization-request'),
        path(f'{url_key}/<str:group>/organizations/organization-request-select2/', group.group_organization_request_select2, name=prefix+'group-organization-request-select2'),
        ...
        path(f'{url_key}/<str:group>/users/add-multiple/', group.group_user_add_multiple, name=prefix+'group-user-add-multiple'),
        ...
        path(f'{url_key}/<str:group>/users/delete/<str:username>/', group.group_user_delete, name=prefix+'group-user-delete'),
        path(f'{url_key}/<str:group>/users/edit/<str:username>/', group.group_user_update, name=prefix+'group-user-edit'),
        path(f'{url_key}/<str:group>/users/member-invite-select2/', group.user_group_member_invite_select2, name=prefix+'group-member-invite-select2'),
        path(f'{url_key}/<str:group>/group-invite-select2/', group.group_invite_select2, name=prefix+'group-invite-select2'),
        path(f'{url_key}/<str:group>/group-group-invite-delete/', group.group_group_invite_delete, name=prefix+'group-group-invite-delete'),
        ...
        path(f'{url_key}/<str:group>/widgets/add/<str:app_name>/<str:widget_name>/', widget.widget_add_group, name=prefix+'widget-add-group'),
        
        path(f'{url_key}/<str:group>/reflectedassign/', group.group_assign_reflected_object, name=prefix+'group-assign-reflected'),
        path(f'{url_key}/<str:group>/attachmentselect/<str:model>', attached_object.attachable_object_select2_view, name=prefix+'attached_object_select2_view'),
    ]
...
if settings.COSINNUS_V3_FRONTEND_ENABLED:
    ...
    urlpatterns += [
        path('setup/profile/', TemplateView.as_view(template_name='premium_info_page.html'), name='v3-frontend-setup-profile'),
    ]
