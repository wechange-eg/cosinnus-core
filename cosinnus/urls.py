...
urlpatterns = [
    ...
    url(r'^housekeeping/print_digest_daily/', housekeeping.print_testdigest_daily, name='housekeeping-print-digest-daily'),
    url(r'^housekeeping/print_digest_weekly/', housekeeping.print_testdigest_weekly, name='housekeeping-print-digest-weekly'),
