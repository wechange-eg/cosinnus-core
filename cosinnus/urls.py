...
urlpatterns += patterns('cosinnus.views',
    ...
    url(r'^group/(?P<group>[^/]+)/users/add/$', 'group.group_user_add', name='group-user-add'),
    url(r'^group/(?P<group>[^/]+)/users/add/(?P<username>[^/]+)/$', 'group.group_user_add', name='group-user-add-username'),
    url(r'^group/(?P<group>[^/]+)/users/delete/$', 'group.group_user_delete', name='group-user-delete'),
    url(r'^group/(?P<group>[^/]+)/users/delete/(?P<username>[^/]+)/$', 'group.group_user_delete', name='group-user-delete-username'),
