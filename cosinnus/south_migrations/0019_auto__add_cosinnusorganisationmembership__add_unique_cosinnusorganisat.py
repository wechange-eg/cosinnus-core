...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cosinnus_cosinnusgroup', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'groups', null=True, on_delete=models.SET_NULL, to=orm['cosinnus.CosinnusOrganisation']),
                      keep_default=False)
