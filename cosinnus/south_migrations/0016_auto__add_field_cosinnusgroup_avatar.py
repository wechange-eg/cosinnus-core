...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.avatar'
        db.add_column(u'cosinnus_cosinnusgroup', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.avatar'
        db.delete_column(u'cosinnus_cosinnusgroup', 'avatar')
