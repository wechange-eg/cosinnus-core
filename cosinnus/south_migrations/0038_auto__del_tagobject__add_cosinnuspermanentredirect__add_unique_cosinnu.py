...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CosinnusPermanentRedirect'
        db.create_table(u'cosinnus_cosinnuspermanentredirect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_portal', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'redirects', to=orm['cosinnus.CosinnusPortal'])),
            ('from_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('from_slug', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('to_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'redirects', to=orm['cosinnus.CosinnusGroup'])),
        ))
        db.send_create_signal(u'cosinnus', ['CosinnusPermanentRedirect'])

        # Adding unique constraint on 'CosinnusPermanentRedirect', fields ['from_portal', 'from_type', 'from_slug']
        db.create_unique(u'cosinnus_cosinnuspermanentredirect', ['from_portal_id', 'from_type', 'from_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'CosinnusPermanentRedirect', fields ['from_portal', 'from_type', 'from_slug']
        db.delete_unique(u'cosinnus_cosinnuspermanentredirect', ['from_portal_id', 'from_type', 'from_slug'])

        # Deleting model 'CosinnusPermanentRedirect'
        db.delete_table(u'cosinnus_cosinnuspermanentredirect')
    ...
    models = {
        ...
        u'cosinnus.cosinnuspermanentredirect': {
            'Meta': {'unique_together': "((u'from_portal', u'from_type', u'from_slug'),)", 'object_name': 'CosinnusPermanentRedirect'},
