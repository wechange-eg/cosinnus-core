...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusPortal.users_need_activation'
        db.add_column(u'cosinnus_cosinnusportal', 'users_need_activation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusPortal.users_need_activation'
        db.delete_column(u'cosinnus_cosinnusportal', 'users_need_activation')
