...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CosinnusPermanentRedirect', fields ['from_portal', 'to_group', 'from_slug']
        db.create_unique(u'cosinnus_cosinnuspermanentredirect', ['from_portal_id', 'to_group_id', 'from_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'CosinnusPermanentRedirect', fields ['from_portal', 'to_group', 'from_slug']
        db.delete_unique(u'cosinnus_cosinnuspermanentredirect', ['from_portal_id', 'to_group_id', 'from_slug'])
