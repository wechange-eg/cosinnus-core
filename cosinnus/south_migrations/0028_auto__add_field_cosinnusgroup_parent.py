...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.parent'
        db.add_column(u'cosinnus_cosinnusgroup', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'groups', null=True, on_delete=models.SET_NULL, to=orm['cosinnus.CosinnusGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.parent'
        db.delete_column(u'cosinnus_cosinnusgroup', 'parent_id')
