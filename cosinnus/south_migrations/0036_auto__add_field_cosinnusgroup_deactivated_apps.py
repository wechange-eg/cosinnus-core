...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.deactivated_apps'
        db.add_column(u'cosinnus_cosinnusgroup', 'deactivated_apps',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.deactivated_apps'
        db.delete_column(u'cosinnus_cosinnusgroup', 'deactivated_apps')
