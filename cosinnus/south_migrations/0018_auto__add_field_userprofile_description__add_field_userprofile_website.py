...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cosinnus_userprofile', 'description',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.website'
        db.add_column(u'cosinnus_userprofile', 'website',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cosinnus_userprofile', 'description')

        # Deleting field 'UserProfile.website'
        db.delete_column(u'cosinnus_userprofile', 'website')
