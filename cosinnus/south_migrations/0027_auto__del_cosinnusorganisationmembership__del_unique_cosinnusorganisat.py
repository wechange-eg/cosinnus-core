...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CosinnusOrganisationMembership', fields ['user', 'organisation']
        db.delete_unique(u'cosinnus_cosinnusorganisationmembership', ['user_id', 'organisation_id'])

        # Deleting model 'CosinnusOrganisationMembership'
        db.delete_table(u'cosinnus_cosinnusorganisationmembership')

        # Deleting model 'CosinnusOrganisation'
        db.delete_table(u'cosinnus_cosinnusorganisation')

        # Deleting field 'CosinnusGroup.organisation'
        db.delete_column(u'cosinnus_cosinnusgroup', 'organisation_id')


    def backwards(self, orm):
        # Adding model 'CosinnusOrganisationMembership'
        db.create_table(u'cosinnus_cosinnusorganisationmembership', (
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('organisation', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'memberships', to=orm['cosinnus.CosinnusOrganisation'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_organisation_memberships', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'cosinnus', ['CosinnusOrganisationMembership'])

        # Adding unique constraint on 'CosinnusOrganisationMembership', fields ['user', 'organisation']
        db.create_unique(u'cosinnus_cosinnusorganisationmembership', ['user_id', 'organisation_id'])

        # Adding model 'CosinnusOrganisation'
        db.create_table(u'cosinnus_cosinnusorganisation', (
        ...
        db.send_create_signal(u'cosinnus', ['CosinnusOrganisation'])

        # Adding field 'CosinnusGroup.organisation'
        db.add_column(u'cosinnus_cosinnusgroup', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'groups', null=True, to=orm['cosinnus.CosinnusOrganisation'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
