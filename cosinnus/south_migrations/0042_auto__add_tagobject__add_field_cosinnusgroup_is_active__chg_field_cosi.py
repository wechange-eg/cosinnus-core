...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.is_active'
        db.add_column(u'cosinnus_cosinnusgroup', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.is_active'
        db.delete_column(u'cosinnus_cosinnusgroup', 'is_active')
