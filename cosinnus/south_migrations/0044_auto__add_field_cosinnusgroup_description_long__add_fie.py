...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CosinnusGroup.description_long'
        db.add_column(u'cosinnus_cosinnusgroup', 'description_long',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CosinnusGroup.contact_info'
        db.add_column(u'cosinnus_cosinnusgroup', 'contact_info',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CosinnusGroup.wallpaper'
        db.add_column(u'cosinnus_cosinnusgroup', 'wallpaper',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'CosinnusGroup.description_long'
        db.delete_column(u'cosinnus_cosinnusgroup', 'description_long')

        # Deleting field 'CosinnusGroup.contact_info'
        db.delete_column(u'cosinnus_cosinnusgroup', 'contact_info')

        # Deleting field 'CosinnusGroup.wallpaper'
        db.delete_column(u'cosinnus_cosinnusgroup', 'wallpaper')
    ...
    models = {
        ...
        u'cosinnus.cosinnusgroup': {
            ...
            'wallpaper': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
