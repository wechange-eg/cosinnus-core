...
class AddContainerView(RequireWriteMixin, FilterGroupMixin, HierarchyPathMixin, CreateView):
    """
    ...
    def get_success_url(self):
        return group_aware_reverse('cosinnus:%s:list' % self.appname, kwargs={'group': self.group})
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['cancel_url'] = group_aware_reverse('cosinnus:%s:list' % self.appname, kwargs={'group': self.group})
        return context
