...
UI_PREF_DASHBOARD_HIDDEN_DECK_MIGRATION = 'dashboard_deck_migration__hidden'
...
ALL_UI_PREFS = {
    ...
    UI_PREF_DASHBOARD_HIDDEN_DECK_MIGRATION: forms.BooleanField(initial=False, required=False),
