...
class CosinnusProjectTransBase(object):
    ...
    FORMFIELD_VISIBILITY_LEGEND = _('Should your project be visible for the anonymous users? The microsite may be found via the Internet and the portal search.')
    ...
    FORMFIELD_PUBLIC_LEGEND = _('Here you can control whether the publicly visible information about your project, such as name and address, is transmitted to partner platforms by WECHANGE.')
...
class CosinnusSocietyTransBase(CosinnusProjectTransBase):
    ...
    FORMFIELD_VISIBILITY_LEGEND = _('Should your group be visible for the anonymous users? The microsite may be found via the Internet and the portal search.')
    ...
    FORMFIELD_PUBLIC_LEGEND = _('Here you can control whether the publicly visible information about your group, such as name and address, is transmitted to partner platforms by WECHANGE.')
...
class CosinnusConferenceTransBase(CosinnusProjectTransBase):
    ...
    FORMFIELD_VISIBILITY_LEGEND = _('Should your conference be visible for the anonymous users? The microsite may be found via the Internet and the portal search.')
    ...
    FORMFIELD_PUBLIC_LEGEND = _('Here you can control whether the publicly visible information about your conference, such as name and address, is transmitted to partner platforms by WECHANGE.')
