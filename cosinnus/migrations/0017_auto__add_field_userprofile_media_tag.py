...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.media_tag'
        db.add_column(u'cosinnus_userprofile', 'media_tag',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.media_tag'
        db.delete_column(u'cosinnus_userprofile', 'media_tag_id')
