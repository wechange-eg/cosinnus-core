...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetConfig.sort_field'
        db.add_column(u'cosinnus_widgetconfig', 'sort_field',
                      self.gf('django.db.models.fields.CharField')(default=u'999', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetConfig.sort_field'
        db.delete_column(u'cosinnus_widgetconfig', 'sort_field')
