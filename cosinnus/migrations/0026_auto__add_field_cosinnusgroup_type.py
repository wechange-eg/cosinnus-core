...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.type'
        db.add_column(u'cosinnus_cosinnusgroup', 'type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.type'
        db.delete_column(u'cosinnus_cosinnusgroup', 'type')
