...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.settings'
        db.add_column(u'cosinnus_userprofile', 'settings',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.settings'
        db.delete_column(u'cosinnus_userprofile', 'settings')
