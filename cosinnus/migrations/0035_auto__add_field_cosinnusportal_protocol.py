...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusPortal.protocol'
        db.add_column(u'cosinnus_cosinnusportal', 'protocol',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusPortal.protocol'
        db.delete_column(u'cosinnus_cosinnusportal', 'protocol')
