...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'TagObject.place' to 'TagObject.location_place'
        db.rename_column(u'cosinnus_tagobject', 'place', 'location_place')

        # Renaming field 'TagObject.name' to 'TagObject.people_name'
        db.rename_column(u'cosinnus_tagobject', 'name', 'people_name')

        # Adding field 'TagObject.group'
        db.add_column(u'cosinnus_tagobject', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, to=orm['cosinnus.CosinnusGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Renaming field 'TagObject.place' to 'TagObject.location_place'
        db.rename_column(u'cosinnus_tagobject', 'location_place', 'place')

        # Renaming field 'TagObject.name' to 'TagObject.people_name'
        db.rename_column(u'cosinnus_tagobject', 'people_name', 'name')

        # Deleting field 'TagObject.group'
        db.delete_column(u'cosinnus_tagobject', 'group_id')
