...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WidgetConfigItem', fields ['config_key']
        db.create_index(u'cosinnus_widgetconfigitem', ['config_key'])

        # Adding unique constraint on 'WidgetConfigItem', fields ['config', 'config_key']
        db.create_unique(u'cosinnus_widgetconfigitem', ['config_id', 'config_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'WidgetConfigItem', fields ['config', 'config_key']
        db.delete_unique(u'cosinnus_widgetconfigitem', ['config_id', 'config_key'])

        # Removing index on 'WidgetConfigItem', fields ['config_key']
        db.delete_index(u'cosinnus_widgetconfigitem', ['config_key'])
