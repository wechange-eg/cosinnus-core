...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.website'
        db.add_column(u'cosinnus_cosinnusgroup', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.website'
        db.delete_column(u'cosinnus_cosinnusgroup', 'website')
