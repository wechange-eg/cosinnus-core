...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cosinnus_cosinnusportalmembership', (
            ...
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'memberships', to=orm['cosinnus.CosinnusPortal'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_portal_memberships', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'cosinnus', ['CosinnusPortalMembership'])
