...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CosinnusGroup.wallpaper'
        db.alter_column(u'cosinnus_cosinnusgroup', 'wallpaper', self.gf('django.db.models.fields.files.ImageField')(max_length=250, null=True))

        # Changing field 'CosinnusGroup.avatar'
        db.alter_column(u'cosinnus_cosinnusgroup', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'CosinnusGroup.wallpaper'
        db.alter_column(u'cosinnus_cosinnusgroup', 'wallpaper', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'CosinnusGroup.avatar'
        db.alter_column(u'cosinnus_cosinnusgroup', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'cosinnus.cosinnusgroup': {
            ...
            'contact_info': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            ...
            'wallpaper': ('django.db.models.fields.files.ImageField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
        ...
        u'cosinnus.cosinnusportal': {
            ...
            'users_need_activation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
