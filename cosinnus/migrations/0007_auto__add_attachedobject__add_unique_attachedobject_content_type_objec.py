...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AttachedObject'
        db.create_table(u'cosinnus_attachedobject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'cosinnus', ['AttachedObject'])

        # Adding unique constraint on 'AttachedObject', fields ['content_type', 'object_id']
        db.create_unique(u'cosinnus_attachedobject', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AttachedObject', fields ['content_type', 'object_id']
        db.delete_unique(u'cosinnus_attachedobject', ['content_type_id', 'object_id'])

        # Deleting model 'AttachedObject'
        db.delete_table(u'cosinnus_attachedobject')
    ...
    models = {
        ...
        u'cosinnus.attachedobject': {
            'Meta': {'unique_together': "((u'content_type', u'object_id'),)", 'object_name': 'AttachedObject'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
