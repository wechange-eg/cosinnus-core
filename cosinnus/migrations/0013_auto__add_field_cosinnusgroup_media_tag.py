...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosinnusGroup.media_tag'
        db.add_column(u'cosinnus_cosinnusgroup', 'media_tag',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosinnusGroup.media_tag'
        db.delete_column(u'cosinnus_cosinnusgroup', 'media_tag_id')
