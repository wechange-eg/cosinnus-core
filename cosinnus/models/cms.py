...
class CosinnusMicropage(models.Model):
    group = models.ForeignKey(
        settings.COSINNUS_GROUP_OBJECT_MODEL, related_name='micropages', null=True, blank=True, on_delete=models.CASCADE
    )
    title = models.CharField(_('Title'), max_length=100)
    text = models.TextField(verbose_name=_('Text'), blank=True)
    last_edited = models.DateTimeField(verbose_name=_('Last edited'), editable=False, auto_now=True)
