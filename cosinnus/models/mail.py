...
class QueuedMassMail(models.Model):
    ...
    recipients = models.ManyToManyField(
        settings.AUTH_USER_MODEL, verbose_name=_('Recipients'), related_name='queued_mass_mails'
    )
    recipients_sent = models.ManyToManyField(
        settings.AUTH_USER_MODEL, verbose_name=_('Mails sent to Recipients'), related_name='queued_mass_mails_sent'
    )
