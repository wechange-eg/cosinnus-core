...
from cosinnus.core.mail import get_html_mail_data, send_mail_or_fail, send_mail_or_fail_threaded
from cosinnus.models.group import CosinnusPortal


def send_notification_item_html(
    to_user,
    subject,
    context,
    notification_reason=None,
    template='cosinnus/html_mail/summary_item.html',
    extra_data=dict,
):
    """
...
def send_notification_item_html_threaded(
    to_user, subject, context, notification_reason=None, template='cosinnus/html_mail/summary_item.html'
):
    """
    Send notification item mail using context given
    """
