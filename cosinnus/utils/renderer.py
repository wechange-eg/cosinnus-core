...
class BaseRenderer(object):
    ...
    def get_model(cls):
        if not hasattr(cls, 'model'):
            ...
            raise ImproperlyConfigured('Missing model definition for ' 'renderer %s' % cls.__name__)
        return cls.model
    ...
    def get_template(cls):
        if not hasattr(cls, 'template'):
            ...
            raise ImproperlyConfigured('Missing template definition for ' 'renderer %s' % cls.__name__)
        return cls.template
    ...
    def get_template_v2(cls):
        if not hasattr(cls, 'template_v2'):
            ...
            raise ImproperlyConfigured('Missing template_v2 definition for ' 'renderer %s' % cls.__name__)
    ...
    def get_template_single(cls):
        if not hasattr(cls, 'template_single'):
            ...
            raise ImproperlyConfigured('Missing template_single definition for ' 'renderer %s' % cls.__name__)
