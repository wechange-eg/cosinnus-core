...
class PaginationTemplateMixin(object):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(PaginationTemplateMixin, self).get_context_data(*args, **kwargs)
        context['pagination'] = pagination(context['object_list'], self.per_page, self.request.GET)
