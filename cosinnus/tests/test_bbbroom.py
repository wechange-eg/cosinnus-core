    ...
    class BBBRoomTest(TestCase):
        ...
        def setUp(self):
            ...
            self.moderator = User.objects.create_user(
                username='moderator', email='moderator@example.org', is_superuser=True, is_staff=True
            )

            self.attendee = User.objects.create_user(
                username='attendee', email='attendee@example.org', is_superuser=True, is_staff=True
            )
        ...
        def test_creation_settings(self):
            group_bbb_params = {
                'create': {'autoStartRecording': False, 'allowStartStopRecording': False, 'muteOnStart': True},
            }
        ...
        def test_membership_signals(self):
            moderator = User.objects.create_user(
                username='signal_moderator', email='signalmoderator@example.org', is_superuser=True, is_staff=True
            )

            attendee = User.objects.create_user(
                username='signal_attendee', email='signalattendee@example.org', is_superuser=True, is_staff=True
            )
