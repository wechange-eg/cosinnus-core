                ...
                'cards': [
                    {
                        ...
                        'description': (
                            ...
                            '* By **assigning tasks to the responsible members**, you can keep track of who is taking care of what. The assigned members will also see their tasks in their [personal task board](https://%(portal_url)s/personal-board) ↗.\n'
                            ...
                            '* Indem ihr eure Aufgaben den **zuständigen Mitgliedern zuweist**, behaltet ihr den Überlick darüber, wer sich worum kümmert. Die zugewiesenen Mitglieder bekommen ihre Aufgaben auch in ihrem [persönlichen Aufgaben-Board](https://%(portal_url)s/personal-board) ↗ angezeigt.\n'
