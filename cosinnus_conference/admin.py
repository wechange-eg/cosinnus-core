...
from cosinnus.admin import CosinnusConferenceSettingsInline, CosinnusProjectAdmin
...
if settings.COSINNUS_CONFERENCES_ENABLED:
    ...
    class CosinnusConferenceAdmin(CosinnusProjectAdmin):
        ...
        inlines = CosinnusProjectAdmin.inlines + [CosinnusConferencePremiumBlockInline]
        readonly_fields = ('created', 'last_modified', 'is_premium_currently', 'attached_objects')
        exclude = CosinnusProjectAdmin.exclude + [
            'enable_user_premium_choices_until',
        ]
