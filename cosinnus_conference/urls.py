...
cosinnus_group_patterns = [
    ...
    url(r'^participation-manangement/participants-details-download/$', views.conference_participants_details_download ,
        name='participants-details-download'),
    url(r'^participation-manangement/participants-signatures-download/$', views.conference_participants_signatures_download,
        name='participants-signatures-download'),
