...
import { UserProps, UserJson, User, LoginFormValues, SessionAuthState } from "../types/user"
...
export const login = createAsyncThunk(
  "user/login",
  async (
    values: LoginFormValues | null, thunkAPI: any
  ): Promise<UserProps | undefined> => {
    try {
...
const sessionAuthSlice = createSlice({
  name: "sessionAuth",
  initialState: { isLoggedIn:false, isFetching: false, userIsAnonymous: false, userFetched: false  } as SessionAuthState,
  reducers: {},
