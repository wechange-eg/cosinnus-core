    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation_by', models.ForeignKey(related_name='moderated_messages', verbose_name='moderator', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('parent', models.ForeignKey(related_name='next_messages', verbose_name='parent message', blank=True, to='postman.Message', null=True, on_delete=models.CASCADE)),
                ...
                ('sender', models.ForeignKey(related_name='sent_messages', verbose_name='sender', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('thread', models.ForeignKey(related_name='child_messages', verbose_name='root message', blank=True, to='postman.Message', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['-sent_at', '-id'],
