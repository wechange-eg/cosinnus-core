...
notifications = {
    ...
    'poll_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on your poll %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on your poll %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
        'is_html': True,
        ...
        'data_attributes': {
            ...
            'image_url': 'poll.creator.cosinnus_profile.get_avatar_thumbnail_url',
    ...
    'tagged_poll_comment_posted': {
        ...
        'alert_text_multi': ngettext_lazy(
            '%(sender_name)s and %(count_minus_one)d other commented on the poll %(object_name)s',
            '%(sender_name)s and %(count_minus_one)d others commented on the poll %(object_name)s',
            'count_minus_one',
        ),
        'alert_multi_type': 1,
