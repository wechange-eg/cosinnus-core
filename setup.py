...
setup(
    ...
    dependency_links=[
        ...
        'git+https://github.com/wechange-eg/django-select2.git@django2#egg=django-select2',
        'git+https://github.com/wechange-eg/django-osm-field.git@django2#egg=django-osm-field',
        'git+https://github.com/wechange-eg/python-markdown2.git@2.4.8-WE#egg=markdown2',
